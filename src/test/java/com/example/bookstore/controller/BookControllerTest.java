...
public class BookControllerTest {
    ...
    void search_ValidBookSearchParametersDto_ListBookDto() throws Exception {
        ...
        MvcResult result = mockMvc.perform(
                get("/books/search")
                        .content(jsonRequest)
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("fromPrice", String.valueOf(bookSearchParametersDto.getFromPrice()))
                        .param("toPrice", String.valueOf(bookSearchParametersDto.getToPrice())))
                .andExpect(status().isOk())
                .andReturn();
    ...
    private BookDtoWithoutCategoryIds getBookDtoWithoutCategoryIds1() {
        ...
        dto1.setPrice(BigDecimal.valueOf(20));
    ...
    private BookDtoWithoutCategoryIds getBookDtoWithoutCategoryIds2() {
        ...
        dto2.setPrice(BigDecimal.valueOf(40));
